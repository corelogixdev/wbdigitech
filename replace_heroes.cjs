...
function processFile(filePath) {
    ...
    if (startIndex !== -1 && endIndex !== -1 && endIndex > startIndex) {
        ...
        if (filePath.includes('google_ads')) category = "Google Ads";
        else if (filePath.includes('graphic_design')) category = "Graphic Design";
        else if (filePath.includes('mobile_application')) category = "Mobile Apps";
        else if (filePath.includes('seo')) category = "SEO";
        else if (filePath.includes('social_media')) category = "Social Media";
        else if (filePath.includes('website')) category = "Web Development";
...
const servicesDir = path.join(__dirname, 'resources/views/pages/services');
