<footer class="footer-area text-white" style="background: linear-gradient(90deg, #0A3D62, #0077B6); position: relative; z-index: 5;">
    <!-- Top CTA -->
    <div class="container text-center py-5">
        <h2 class="footer-big-title mb-3 fw-bold" style="font-size: 2.4rem;">
            <a href="javascript:;" class="open-popup text-white text-decoration-none">Let’s Contact!</a>
        </h2>
        <ul class="list-inline mb-3">
            <li class="list-inline-item"><a href="{{ route('home') }}" class="text-white text-decoration-none">Home</a></li>
            <li class="list-inline-item"><a href="{{ route('about') }}" class="text-white text-decoration-none">About Us</a></li>
            <li class="list-inline-item"><a href="{{ route('blogs.public') }}" class="text-white text-decoration-none">Blog</a></li>
            <li class="list-inline-item"><a href="{{ route('customers.public') }}" class="text-white text-decoration-none">Our Clients</a></li>
            <li class="list-inline-item"><a href="{{ route('contact') }}" class="text-white text-decoration-none">Contact</a></li>
            <li class="list-inline-item"><a href="{{ route('careers.public') }}" class="text-white text-decoration-none">Careers</a></li>
        </ul>
        <div>
            ...
            <div class="col-lg-6 text-white">
                <div class="h-100 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <p><a href="https://www.google.com/maps/place/WB+Digitech/@25.256856,55.290083,17z/data=!3m1!4b1!4m6!3m5!1s0x3e5f434e6b4f19b9:0x1b65ad859ed8c1bb!8m2!3d25.256856!4d55.290083!16s%2Fg%2F11s5c4l4t3"  target="_blank" class="text-white text-decoration-none" rel="noopener noreferrer">
