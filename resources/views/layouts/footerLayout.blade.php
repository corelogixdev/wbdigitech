...
<footer class="footer-area text-white"
    style="background: linear-gradient(90deg, #1166a3 0%, #31a8e8 100%); padding:50px 0 0 0;">
    ...
    <div class="container pb-4">
        <div class="row gy-5">
            ...
            <div class="col-lg-3 col-md-6">
                <img src="{{asset('css/new-assets/img/logo/logoo.png')}}" loading="lazy" decoding="async"
                    class="img-fluid mb-3" style="max-width:180px; filter: brightness(0) invert(1);">

                <p class="text-white">Empowering businesses to succeed in the digital age.</p>

                <div class="d-flex gap-3 mt-3">
                    <a href="https://www.linkedin.com/company/wb-digitech/" target="_blank" class="text-white fs-5"><i
                            class="fab fa-linkedin-in"></i></a>
                    <a href="https://www.instagram.com/wbdigitech.ae/" target="_blank" class="text-white fs-5"><i
                            class="fab fa-instagram"></i></a>
                    <a href="https://www.facebook.com/wbdigitechuae/" target="_blank" class="text-white fs-5"><i
                            class="fab fa-facebook-f"></i></a>
                    <a href="https://www.pinterest.com/wbdigitech/" target="_blank" class="text-white fs-5"><i
                            class="fab fa-pinterest"></i></a>
                    <a href="https://x.com/wbdigitech" target="_blank" class="text-white fs-5"><i
                            class="fab fa-x"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled footer-links">
                    ...
                    <li><a href="{{ route('services.seo') }}"
                            class="text-white text-decoration-none d-block mb-2">Search Engine Optimization</a></li>
                    <li><a href="{{ route('services.smm') }}"
                            class="text-white text-decoration-none d-block mb-2">Social Media Marketing</a></li>
                    <li><a href="{{ route('services.app_store_optimization') }}"
                            class="text-white text-decoration-none d-block mb-2">App Store Optimization (ASO)</a></li>
                    <li><a href="{{ route('services.graphic') }}"
                            class="text-white text-decoration-none d-block mb-2">Graphic Designing</a></li>
                    <li><a href="{{ route('services.videography') }}"
                            class="text-white text-decoration-none d-block mb-2">Videography</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled footer-links">
                    <li><a href="{{ route('blogs.public') }}"
                            class="text-white text-decoration-none d-block mb-2">Blogs</a></li>
                    <li><a href="{{ route('careers.public') }}"
                            class="text-white text-decoration-none d-block mb-2">Careers</a></li>
                    <li><a href="{{ route('privacy') }}" class="text-white text-decoration-none d-block mb-2">Privacy
                            Policy</a></li>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"> <i class="fa fa-phone me-2 text-white"></i><a href="tel:+971 4 255 9928"
                        class="text-white text-decoration-none">+971-4-255-9928</a></p>
                <p class="mb-2"><i class="fa fa-phone me-2 text-white"></i><a class="text-white text-decoration-none"
                        href="tel:+971 50 239 0775">+971-50-239-0775</a></p>
