                    ...
                    <div class="ck-content">
                            ...
                            <div class="container-fluid home-main-slider">
                                <div class="row justify-content-center">
                                    <div class="col-xxl-12">
                                        ...
                                        <div class="text-center mb-100"><button
                        ...
                        <div class="raw-html-embed">
                            <div class="ab-inner-hero-area ab-inner-hero-bg p-relative about-us-banner">
                                ...
                                <div class="ab-inner-hero-scroll smooth"><a href="#about-info"><span> Scroll to explore
                                        </span></a></div>
                                <div class="container container-1480">
                                    <div class="row">
                                        <div class="col-xl-8">
                                            <div class="ab-inner-hero-title-box"><span
                                                    class="ab-inner-hero-subtitle">Digital <br> creative agency</span>
                                                <h2 class="ab-inner-hero-title tp-char-animation">Building Digital Presence
                                                </h2>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-xl-5 col-lg-8">
                                            <div class="ab-inner-hero-content">
                                                <p> Develops, designs &amp; delivers websites &amp; creative campaigns that
                                                    drive results. </p><a class="tp-btn-white-sm border-style d-none"
                                                    href="#">Our Story</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="ab-about-area ab-about-mt pb-0 z-index-5">
                                <div class="container container-1480">
                                    <div class="row align-items-center mb-100">
                                            ...
                                            <div id="about-info">
                                                <div class="ab-about-content p-relative">
                                                    ...
                                                    <p class="tp-dropcap tp_fade_bottom">
                                                        ...
                                                        experts, content writers, &amp; marketers.!
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="ab-about-right-thumb p-relative">
                                                <img class="inner-img z-index-5"
                                                    src="{{ asset('css/new-assets/about_us/image_about.webp') }}"
                                                    alt="About Us">
                                                <img src="{{ asset('css/new-assets/about_us/banner_about.webp') }}"
                                                    alt="about-wb-digitech">
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4col-lg-5 col-md-4 mb-40">
                                                    <div class="ab-about-category-title-box p-relative">
                                                        <h4 class="ab-about-category-title">Something <br><span>WHAT I
                                                                DO</span></h4><img
