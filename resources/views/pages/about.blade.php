...
<div id="smooth-wrapper">
    <div id="smooth-content">
        <main>
            ...
            <!-- Let's Create CTA Section -->
            <section class="py-5">
                <div class="container container-1500">
                    <div class="wb-card-box text-center" style="background: linear-gradient(135deg, #0A3D62, #004d7a); color: #fff;">
                        <h2 class="fw-bolder mb-4" style="font-size: 2.5rem; color: #ffffff; text-shadow: 0 2px 10px rgba(255,255,255,0.2);">Let's Create Digital Masterpieces Together</h2>
                        <p class="mb-4 mx-auto" style="font-size: 1.2rem; max-width: 800px; color: #e2e8f0;">
                            Whether you are to create a new brand identity or to grow your present digital footprint, WB-Digitech is here to help.
                        </p>
                        <p class="mb-5 fst-italic" style="font-size: 1.3rem; color: #00B4D8;">
                            Let's connect and turn your vision into reality.
                        </p>

                        <div class="row text-center mb-5 justify-content-center">
                            <div class="col-md-4 mb-4">
                                <div style="background: rgba(255,255,255,0.1); width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                </div>
                                <h5 class="fw-bold text-white">Dubai, UAE</h5>
                            </div>
                            <div class="col-md-4 mb-4">
                                <div style="background: rgba(255,255,255,0.1); width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                                ...
                                <p class="mb-1 text-white">+971 50 239 0775</p>
                                <p class="mb-1 text-white">+971 50 341 6284</p>
                                <p class="mb-0 text-white">+971-4-255-9928</p>
                            </div>
                            <div class="col-md-4 mb-4">
                                <div style="background: rgba(255,255,255,0.1); width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                </div>
                                <p class="mb-1 text-white">info@wbdigitech.ae</p>
                                <p class="mb-0 text-white">www.wbdigitech.ae</p>
                            </div>
                        </div>

                        <a href="{{ route('contact') }}" class="btn px-5 py-3 rounded-pill fw-bold" style="color: #0A3D62; background: #fff; text-transform: uppercase; letter-spacing: 1px;">
                            Get a Free Quote
                        </a>
                    </div>
                </div>
                ...
                <div class="container container-1500">
                    <div class="row justify-content-center mb-5">
                        <div class="col-md-8 text-center">
                            <span class="text-uppercase mb-2" style="color: #CC7A00; font-weight: 600; letter-spacing: 1px; font-size: 14px; display: block;">The Experts</span>
                            <h2 class="fw-bolder" style="color: #0A3D62; font-size: 2.5rem;">Our Team</h2>
                        ...
                        @foreach($teamMembers as $member)
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="wb-team-card">
                                    <img src="{{ asset('storage/' . $member->image) }}" alt="{{ $member->name }}" class="wb-team-img">
                                    <h4 class="fw-bold" style="color: #0A3D62;">{{ $member->name }}</h4>
                                    <p class="text-muted mb-0">{{ $member->speciality }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="container container-1500">
                    <div class="row align-items-center g-5">
                        <div class="col-xl-4 text-center text-xl-start">
                            <span class="badge bg-primary bg-opacity-10 text-primary px-4 py-2 mb-3 rounded-pill" style="font-size: 14px; font-weight: 600;">Our Facts</span>
                            <h2 class="fw-bolder" style="color: #0A3D62; font-size: 2.5rem;">Agency<br>Snapshots</h2>
                        </div>
                        <div class="col-xl-8">
                            <div class="row g-4">
                                <div class="col-sm-6">
                                    <div class="wb-stat-card">
                                        <span class="display-4 fw-bold wb-gradient-text">50+</span>
                                        <p class="mt-2 fw-semibold text-muted mb-0">PROJECTS COMPLETED</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="wb-stat-card">
                                        <span class="display-4 fw-bold wb-gradient-text">5+</span>
                                        <p class="mt-2 fw-semibold text-muted mb-0">YEARS OF EXPERIENCE</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="wb-stat-card">
                                        <span class="display-4 fw-bold wb-gradient-text">21+</span>
                                        <p class="mt-2 fw-semibold text-muted mb-0">TEAM MEMBERS</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="wb-stat-card">
                                        <span class="display-4 fw-bold wb-gradient-text">100%</span>
                                        <p class="mt-2 fw-semibold text-muted mb-0">GROWING AGENCY</p>
                                    </div>
                                </div>
                            </div>
                        </div>
