...
<div class="box-gray-100">
    <div class="services-grid">
        ...
        <div class="service-item">
            ...
            <div>
                <h4><a href="{{ route('ai_social_media') }}" style="color:#001f4d; text-decoration:none;">AI Social Media Marketing</a></h4>
                <p>Leverage AI to manage social media campaigns efficiently, target the right audience, and maximize engagement on all platforms.</p>
            </div>
        </div>
        ...
        <div class="service-item">
            ...
            <div>
                <h4><a href="{{ route('ai_website') }}" style="color:#001f4d; text-decoration:none;">AI Website</a></h4>
        ...
        <div class="service-item">
            ...
            <div>
                <h4><a href="{{ route('ai_digital_marketing') }}" style="color:#001f4d; text-decoration:none;">AI Digital Marketing</a></h4>
                <p>Use AI-powered strategies for digital campaigns including email, PPC, content marketing, and analytics for optimal ROI.</p>
            </div>
        </div>
        ...
        <div class="service-item">
            ...
            <div>
                <h4><a href="{{ route('ai_seo') }}" style="color:#001f4d; text-decoration:none;">AI Powered SEO</a></h4>
        ...
        <div class="service-item">
            ...
            <div>
                <h4><a href="{{ route('ai_google_ads') }}" style="color:#001f4d; text-decoration:none;">AI Google Ads</a></h4>
                <p>Optimize Google Ads campaigns using AI to improve targeting, bidding, and ad performance for better ROI.</p>
            </div>
        </div>
        ...
        <div class="service-item">
            ...
            <div>
                <h4><a href="{{ route('ai_web_app') }}" style="color:#001f4d; text-decoration:none;">AI Web App Development</a></h4>
                <p>Build scalable, intelligent web applications powered by AI to enhance user experience and streamline business processes.</p>
            </div>
        </div>
