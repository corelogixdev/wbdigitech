        ...
        <div id="smooth-content">
                    ...
                    <div class="ck-content">
                        ...
                        <div class="raw-html-embed">
                            ...
                            <div class="modern-glow-hero" style="background-image: url('{{ asset('css/new-assets/services_home/main.webp') }}');">
                                ...
                                <div class="container hero-container position-relative z-index-2" style="padding-top: 60px; padding-bottom: 60px;">
                                    <div class="row align-items-center">
                                        
                                        <!-- Left Side: Hero Content -->
                                        <div class="col-lg-6 mb-5 mb-lg-0 pr-lg-5 text-start">
                                            <div class="glass-hero-content text-start border-0 shadow-none bg-transparent p-0" style="backdrop-filter: none;">
                                                <span class="hero-badge mb-3 d-inline-block">Award-Winning Digital Agency</span>
                                                <h1 class="glow-title" style="text-align: left; font-size: 3rem;">
                                                    Leading Digital Marketing <br> Agency in Dubai, UAE
                                                </h1>
                                                <p class="hero-subtitle mt-4 text-start" style="font-size: 1.1rem; line-height: 1.6;">
                                                ...
                                                <div class="hero-actions mt-5 d-flex gap-3 justify-content-start flex-wrap">
                                            ...
                                            <div class="card border-0 shadow-lg" style="border-radius: 12px; background: rgba(255, 255, 255, 0.85); backdrop-filter: blur(15px); border: 1px solid rgba(255,255,255,0.5) !important;">
                                                <div class="card-body p-4 p-md-5">
                                                    ...
                                                    <form method="POST" action="{{ route('contact.send') }}" class="contact-form hero-dark-form">
                                                        ...
                                                        @if(session('success'))
                                                            <div class="alert alert-success text-center mb-4" style="border-radius: 8px; font-weight: 500; background: rgba(25, 135, 84, 0.2); color: #0A3D62; border: 1px solid rgba(25, 135, 84, 0.5);">
                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <!-- Service Selection -->
                                                            <div class="col-12">
                                                                <select name="service" class="form-select form-select-lg bg-light text-dark custom-input" required>
                                                            ...
                                                            <div class="col-12 mt-4">
                                                                <button type="submit" class="btn btn-lg w-100 text-white fw-bold shadow-sm" style="background: linear-gradient(90deg, #0A3D62 0%, #0077B6 100%); border-radius: 6px; padding: 14px; font-size: 16px;">
                                                                    Get Your Quote <i class="fa-solid fa-arrow-right ms-2"></i>
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </form>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", async () => {
                    ...
                    const totalReviews = data.result.reviews.length;
                    ...
                    const swiper = new Swiper('.testimonial-slider', {
                        slidesPerView: 3,
                        spaceBetween: 20,
                        loop: false, // Set to false for correct pagination
                        autoplay: {
                            delay: 3000,
