...
@section('content')
    ...
    <div class="main-wrapper">
        ...
        <div class="tp-hero-content text-center">
            <p class="delay-load">
                Paid traffic sounds simple. Launch ads, get clicks, watch leads roll in. Except it rarely works that way. A
                campaign can look active and still do nothing. The budget gets spent, reports look busy, while growth stays
                flat. That is why choosing the right Google Ads Agency matters more than most businesses realize.
                At WB, we manage intent, timing, and pressure. Sometimes aggressively and sometimes patiently. As a digital
                marketing agency in Dubai, we see this pattern often. Ads are running, but direction is missing.
            </p>
        ...
        <div class="hero-image-section">
            <div class="hero-image-container">
                <img src="{{ asset('css/new-assets/google_ads/google_ads_marketing.webp') }}" alt="website-design"
                    class="hero-image">
            </div>
        </div>
