...
@section('content')
    ...
    <div class="main-wrapper">
        ...
        <div class="tp-hero-content text-center">
            <p class="delay-load">
                Sometimes, digital ads get skipped, emails go unopened, but a well-crafted leaflet still works. It gets
                picked up, gets read, and it stays around longer than most people expect.
            </p>

            <p>
                Our leaflet design service is tailored for brands seeking clarity, creativity, and results. We design
                leaflets that speak directly to your audience, without trying too hard. The goal is simple: make your
                message visible, readable, and convincing.
            </p>

            <p>
                We are leaflet design experts who understand that design is not decoration. It is communication; bold or
                minimal but always intentional.
            </p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="tp-blog-standard-thumb-box p-relative">
                                <img src="{{ asset('css/new-assets/graphic_design/leaflet.webp') }}"
                                    alt="leaflet-design-services">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-flex">
            ...
            <div class="content-col">
                ...
                <p>Our leaflet design service focuses on strategy before visuals. Design decisions are based on audience
                ...
                <p>Yes, depending on the scope. Our leaflet design service includes flexible timelines without sacrificing
                ...
                <p>Absolutely, every leaflet is delivered in print-ready formats, with proper bleed, margins, and color
                    settings.</p>
