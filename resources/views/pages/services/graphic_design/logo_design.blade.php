    ...
    <div class="main-wrapper">
        ...
        <div class="hero-image-section">
            <div class="hero-image-container">
                <img src="{{ asset('css/new-assets/graphic_design/logo.webp') }}" alt="graphic-design" class="hero-image">
            </div>
        </div>
        <br>
        <br>
        ...
        <div class="container-flex">
            ...
            <div class="content-col">
                ...
                {{-- <img class="service-img" src="https://wbdigitech.ae/wp-content/uploads/2022/09/graphic-banner.png"
                    alt="Graphic Design Service Banner"> --}}
