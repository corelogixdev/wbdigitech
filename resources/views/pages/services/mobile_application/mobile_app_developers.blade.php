    ...
    <div class="main-wrapper">
        ...
        <div class="hero-image-section">
            <div class="hero-image-container">
                <img src="{{ asset('css/new-assets/mobile_app/mobile_app_dev.jpg') }}" alt="mobile-app" class="hero-image">
            ...
            <div class="sidebar-col">
                <div class="sidebar">
                    ...
                    <ul>
                        ...
                        <li class="current-menu-item"><a href="{{ route('services.mobile_app_developers') }}">Hire Mobile
                                App Developers</a></li>
                    </ul>
                    ...
                    <div class="sidebar-images">
                        {{-- <img src="https://wbdigitech.ae/wp-content/uploads/2022/09/mobile-app-deveopment-1024x946.png"
                            alt="Mobile App">
                        <img src="https://wbdigitech.ae/wp-content/uploads/2022/09/mobile-application-1024x974.png"
            ...
            <div class="content-col">
                ...
                <div class="process-list">
                    <ol>
                        ...
                        <li><strong>Development:</strong> Build a working app with native frameworks or cross-platform
                            tools.</li>
                        <li><strong>Testing:</strong> Rigorously test across devices to ensure quality and performance.</li>
                        <li><strong>Launch:</strong> Release on the App Store and Play Store, then continuously iterate.
                        </li>
                    </ol>
                </div>
