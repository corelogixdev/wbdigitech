...
@section('content')
    ...
    <div class="main-wrapper">
        ...
        <x-service-hero
            image="css/new-assets/seo_aso/content_marketing.webp" 
            title="Content Marketing Services Dubai That Don’t Sound Like Marketing"
            description="Our content marketing services Dubai brands rely on are built for people first and search engines second. Strategic, honest, and growth-focused content."
            serviceCategory="SEO"
            serviceName="SEO"
        >
        </x-service-hero>
...
<x-service-content-card title="Content That Connects Before It Converts">
...
<x-service-content-card title="Our Content Marketing Services Dubai">
...
@php
$serviceFaqs = [
    ['question' => 'What makes your content marketing services in Dubai different?', 'answer' => '<p>Our content marketing services Dubai approach focuses on clarity and consistency. We write content people
                    actually want to read, while still supporting SEO goals through seo content writing services.</p>'],
    ['question' => 'How often should content be published?', 'answer' => '<p>There’s no single rule. Consistency matters more than volume. A realistic schedule supported by a clear
                    content marketing agency Dubai strategy usually performs best.</p>'],
    ['question' => 'Can your content help with SEO growth?', 'answer' => '<p>Yes. As a professional content writing company, we align content with search intent, structure, and
                    relevance, which supports long-term visibility.</p>'],
    ['question' => 'Do you only work with businesses in Dubai?', 'answer' => '<p>No. While we’re a content marketing agency Dubai brands trust locally, we also work with regional and
                    international clients.</p>'],
    ['question' => 'Is content marketing suitable for small businesses?', 'answer' => '<p>Absolutely. With the right content marketing services Dubai plan, small businesses can build authority
