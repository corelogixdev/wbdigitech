...
@section('content')
    ...
    <div class="main-wrapper">
        ...
        <x-service-hero
            image="css/new-assets/web_imgs/ContentWriting01.webp" 
            title="Words That Make People Stop Scrolling"
            description="Choosing the right content writing company is rarely simple. Everyone claims they write well. Everyone says their words convert. But good content feels different. It reads like someone understood your business before typing a single word.    At WB Digitech, content is written with intent. Sometimes persuasive, sometimes calm, sometimes straight to the point. Our content writing service is built to inform, rank, and quietly convince users to stay longer, scroll more, and act. That is how strong content ends up being published."
...
<x-service-content-card title="Why Businesses Choose Us">
<p>
...
<x-service-content-card title="Content Writing Services That Fit Your Brand Voice">
<p>
...
<x-service-content-card title="A Reliable Content Writing Agency in Dubai">
<p>
...
<x-service-content-card title="Serving Businesses Across the UAE and Beyond">
<p>
...
<x-service-content-card title="SEO, Strategy, and Substance Combined">
<p>
...
<x-service-content-card title="Why Our Content Writing Service Is Different">
<p>
...
<x-service-content-card title="Ready to work with a content writing company that gets it?">
<p>
...
@php
$serviceFaqs = [
    ['question' => 'What does a content writing company actually do?', 'answer' => '<p>
    ...
    ['question' => 'Do you offer SEO content writing services?', 'answer' => '<p>
    ...
    ['question' => 'Do your content writing services extend to all parts of the UAE?', 'answer' => '<p>
    ...
    ['question' => 'How is your content writing agency in Dubai different?', 'answer' => '<p>
    ...
    ['question' => 'Can content support digital marketing campaigns?', 'answer' => '<p>
