...
<
    ...
    <div class="hero-image-section">
        <div class="hero-image-container">
            <img src="{{ asset('css/new-assets/web_imgs/shopifystoredevelopment-01.webp') }}" alt="website-development" class="hero-image">
        ...
        <div class="sidebar-col">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li class="current-menu-item"><a href="{{ route('services.shopify_development') }}">Shopify Development</a></li>
