...
@section('content')
    ...
    <div class="main-wrapper">
        ...
        <x-service-hero
            ...
            title="Web Development Company That Builds More Than Just Websites"
            description="A website is not just code on a screen. It is often the first impression. Sometimes it is the only chance a brand gets. As a web development company, we understand the balance between design, performance, and business goals. Some projects start with a clear vision. Others take shape halfway through. Both are welcome here.    WB Digitech provides website development services that Dubai businesses rely on when they want something practical, scalable, and genuinely useful. We do not chase trends blindly. We build what works, then refine it."
...
<x-service-content-card title="Website Development Services Dubai Businesses Actually Need">
<p>
...
<x-service-content-card title="A Web Development Agency That Mixes Logic With Creativity">
<p>
...
<x-service-content-card title="Why Choose Our Web Development Service in Dubai">
<p>
...
<x-service-content-card title="Best Agency for Web Development That Values Adaptability">
<p>
...
<x-service-content-card title="Web Development Companies in Dubai Compared to Real Needs">
<p>
...
<x-service-content-card title="Web Development Company Services That Scale With You">
<p>
...
<x-service-content-card title="How Our Web Dev Agency Works Behind the Scenes">
<p>
...
<x-service-content-card title="Integrated Growth With the Right Partners">
<p>
...
<x-service-content-card title="Let's Build Something That Actually Works">
<p>
...
@php
$serviceFaqs = [
    ['question' => '1. How do I select the best web development company?', 'answer' => '<p>
    ...
    ['question' => '2. What makes website development services Dubai different from global services?', 'answer' => '<p>
    ...
    ['question' => '3. Are web development companies in Dubai suitable for small businesses?', 'answer' => '<p>
                    Yes. Many web development companies in Dubai offer scalable solutions that start small and expand as
                    the business grows.
                </p>'],
    ['question' => '4. How does a web development agency support long-term growth?', 'answer' => '<p>
    ...
    ['question' => '5. Do you provide both development and marketing support?', 'answer' => '<p>
