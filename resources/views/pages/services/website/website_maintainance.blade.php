...
<div class="main-wrapper">
    ...
    <x-service-hero
            image="css/new-assets/web_imgs/Website development-01.webp" 
            title="Website Maintenance Services Dubai."
            description="In Dubai, we will make sure that your website is safe, updated, and functioning effectively. We have low AMC prices because it will run efficiently, and it will provide you with peace of mind."
...
<x-service-content-card title="Website Maintenance Experts in Dubai.">
...
<x-service-content-card title="Significance of Website Maintenance Dubai">
<p>
...
<x-service-content-card title="Cost-Effective Website Maintenance Services Dubai">
<p>
...
<x-service-content-card title="Essential Elements of Website Maintenance Services Dubai">
<p>
...
<x-service-content-card title="Best Website Maintenance Services Dubai">
<p>
...
@php
$serviceFaqs = [
    ['question' => 'What is your AMC package for your website maintenance?', 'answer' => '<p>
    ...
    ['question' => 'Will My Website Function Properly During Website Maintenance Services Dubai?', 'answer' => '<p>
    ...
    ['question' => 'Will I Be Able to See the Changes Before You Go Live with the Updates in Website Maintenance Services Dubai?', 'answer' => '<p>
                  Yes! During our website maintenance services Dubai, updates are usually made directly on the live site.  </p>'],
    ['question' => 'How Long Will It Take to Complete a Website Maintenance Session in Website Maintenance Services Dubai?', 'answer' => '<p>
                   The duration of website maintenance services Dubai depends on the complexity of updates and fixes. 
                </p>'],
    ['question' => 'Which Is the Most Reliable Website Maintenance Company in Website Maintenance Services Dubai?', 'answer' => '<p>
